...
public class BoardSquare {
	...
	/**
	 * Passed from parent Component, this is the actual x,y pixel location on
	 * that component of the top left pixel, used for painting
	 */
	private int paintX, paintY;

	/**
	 * The logical row and column coordinates of this BoardSquare on the
	 * logicalBoard
	 */
	 ...
	 * 
	 * @param r
	 *            the row of this square on the BoardPanel
	 * @param c
	 *            the column of this square on BoardPanel
	 * @param s
	 *            the size, in pixels, of the width and height to paint
	 * @param pX
	 *            the x pixel location of the top left square of this
	 *            BoardSquare
	 * @param pY
	 *            the y pixel location of the top left square of this
	 *            BoardSquare
	 * @param cs
	 *            a ColorScheme describing the colors of this square.
	 */
	...
	/**
	 * Sets the X and Y coordinates to paint this BoardSquare at (top left) on
