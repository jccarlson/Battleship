...
/**
 * Visual representation of a {@link boardAPI.BattleshipBoard} which extends
 * JPanel
 * <p>
 * Allows for varying amounts of BoardSquares and has a scale attribute which
 * determines how large each BoardSquare should be painted.
 * 
...
public class BoardPanel extends JPanel implements BattleshipListener {
	 ...
	 * 
	 * @param gs
	 *            The gridSize should be equal to a (@link BattleshipBoard}
	 * @param s
	...
	public BoardPanel(int gs, int s, ColorScheme cs) {
		...
		// Set the preferred size of this component to the width and height of
		// the board in pixels,
	...
	/**
	 * Overrides JComponent's paint(g) method, in order to properly paint the
	 * board to the screen.
	 * 
	 ...
	 * 
	 * @param x
	 *            x-coordinate of the pixel which was clicked in relation to the
	 *            top-left of this component.
	 * @param y
	 *            y-coordinate of the pixel which was clicked in relation to the
	 *            top-left of this component.
	 ...
	 * 
	 * @param r
	 *            row of the grid to get the square in relation to the top-left
	 *            of this component.
	 * @param c
	 *            column of the grid to get the square in relation to the
	 *            top-left of this component.
	 * @return the BoardSquare which was clicked.
	 */
	 ...
	 * <p>
	 * Lets the appropriate BoardSquare know it was fired at, and the status of
	 * that shot, so it can change color if needed.
	 * 
