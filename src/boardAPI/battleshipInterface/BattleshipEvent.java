...
public class BattleshipEvent {
	...
	/**
	 * The Ships described by this event, if necessary. Ship is current ship at
	 * location, prevShip is identical but at former location
	 */
	...
	/**
	 * Creates an event which is described by an event code and a row and column
	 * of a board. Convenient for shotFired(e) without SHIP_SUNK
	 * 
	 * @param e
	 *            the event code
	 * @param r
	...
	/**
	 * Creates an event which is described by an event code, row, column, and
	 * Ship. Convenient for shotFired(e) with SHIP_SUNK
	 * 
	 * @param e
	 *            the event code
	 * @param r
	...
	/**
	 * Creates an event described by an event code, the previous ship location,
	 * and a Ship. Convenient for shipMoved(e)
	 * 
	 * @param e
	 *            the event code
	 * @param p
