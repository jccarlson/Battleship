...
public interface BattleshipListener {
	 ...
	 * 
	 * @param e
	 *            A BattleshipEvent which will contain the code for HIT, MISS,
	 *            or INVALID and possibly SHIP_SUNK. Will contain row and col
	 *            and if SHIP_SUNK will contain the sunken Ship.
	 */
	...
	/**
	 * Method called when a ship is moved or placed. If moved, will have
	 * prevShip where the ship used to be and ship where it is now. If placed
	 * for the first time, prevShip will be null.
	 * 
	 * @param e
	 *            A BattleshipEvent which will contain the code for SHIP_MOVED
	 *            and the Ship.
	 */
